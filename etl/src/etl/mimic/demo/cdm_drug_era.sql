CREATE
OR REPLACE TABLE lk_join_voc_drug
AS
...
-- -------------------------------------------------------------------
CREATE
OR REPLACE TABLE tmp_pretarget_drug
AS
...
CREATE
OR REPLACE TABLE tmp_subenddates_un_drug
    AS
...
CREATE
OR REPLACE TABLE tmp_subenddates_rows_drug
AS
SELECT person_id             AS person_id,
       ingredient_concept_id AS ingredient_concept_id,
...
CREATE
OR REPLACE TABLE tmp_subenddates_drug
AS
SELECT person_id             AS person_id,
       ingredient_concept_id AS ingredient_concept_id,
...
CREATE
OR REPLACE TABLE temp_ends_drug
AS
...
CREATE
OR REPLACE TABLE tmp_finaltarget_drug
AS
...
CREATE
OR REPLACE TABLE tmp_enddates_un_drug
    AS
SELECT person_id                    AS person_id,
       ingredient_concept_id        AS ingredient_concept_id,
...
CREATE
OR REPLACE TABLE tmp_enddates_rows_drug
AS
SELECT person_id             AS person_id,
       ingredient_concept_id AS ingredient_concept_id,
       event_date            AS event_date,
...
CREATE
OR REPLACE TABLE tmp_enddates_drug
AS
SELECT person_id                             AS person_id,
       ingredient_concept_id                 AS ingredient_concept_id,
...
CREATE
OR REPLACE TABLE tmp_drugera_ends_drug
AS
...
SELECT hash(uuid())                                                          AS drug_era_id,
       person_id                                                             AS person_id,
