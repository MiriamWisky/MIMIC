...
-- -------------------------------------------------------------------
CREATE
OR REPLACE TABLE lk_prescriptions_clean AS
SELECT
    ...
    CAST(src.ndc AS STRING)                                                    AS ndc_source_code,
...
-- -------------------------------------------------------------------
CREATE
OR REPLACE TABLE lk_pr_ndc_concept AS
...
-- -------------------------------------------------------------------
CREATE
OR REPLACE TABLE lk_pr_gcpt_concept AS
...
-- -------------------------------------------------------------------
CREATE
OR REPLACE TABLE lk_pr_route_concept AS
...
CREATE
OR REPLACE TABLE lk_drug_mapped AS
