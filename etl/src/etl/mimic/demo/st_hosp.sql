CREATE
OR REPLACE TABLE src_diagnoses_icd AS
...
CREATE
OR REPLACE TABLE src_services AS
SELECT subject_id   AS subject_id,
       hadm_id      AS hadm_id,
...
CREATE
OR REPLACE TABLE src_labevents AS
...
CREATE
OR REPLACE TABLE src_d_labitems AS
...
CREATE
OR REPLACE TABLE src_procedures_icd AS
SELECT subject_id       AS subject_id,
       hadm_id          AS hadm_id,
       icd_code         AS icd_code,
       icd_version      AS icd_version,
...
CREATE
OR REPLACE TABLE src_hcpcsevents AS
...
CREATE
OR REPLACE TABLE src_drgcodes AS
SELECT hadm_id      AS hadm_id,
       subject_id   AS subject_id,
...
CREATE
OR REPLACE TABLE src_prescriptions AS
SELECT hadm_id          AS hadm_id,
       subject_id       AS subject_id,
...
CREATE
OR REPLACE TABLE src_microbiologyevents AS
...
-- CREATE OR REPLACE TABLE src_d_micro AS
-- SELECT
...
CREATE
OR REPLACE TABLE src_d_micro AS
WITH d_micro AS (
...
CREATE
OR REPLACE TABLE src_pharmacy AS
