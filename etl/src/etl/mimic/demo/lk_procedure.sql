...
CREATE
OR REPLACE TABLE lk_hcpcsevents_clean AS
...
CREATE
OR REPLACE TABLE lk_procedures_icd_clean AS
SELECT src.subject_id                 AS subject_id,
       src.hadm_id                    AS hadm_id,
       adm.dischtime                  AS start_datetime,
...
CREATE
OR REPLACE TABLE lk_proc_d_items_clean AS
SELECT src.subject_id    AS subject_id,
       src.hadm_id       AS hadm_id,
...
CREATE
OR REPLACE TABLE lk_hcpcs_concept AS
...
CREATE
OR REPLACE TABLE lk_icd_proc_concept AS
...
CREATE
OR REPLACE TABLE lk_itemid_concept AS
...
CREATE
OR REPLACE TABLE lk_procedure_mapped AS
