CREATE
OR REPLACE TABLE lk_admissions_clean AS
...
CREATE
OR REPLACE TABLE lk_transfers_clean AS
SELECT src.subject_id                     AS subject_id,
...
CREATE
OR REPLACE TABLE lk_services_duplicated AS
SELECT trace_id,
       COUNT(*) AS row_count
...
CREATE
OR REPLACE TABLE lk_services_clean AS
SELECT src.subject_id    AS   subject_id,
       src.hadm_id       AS   hadm_id,
