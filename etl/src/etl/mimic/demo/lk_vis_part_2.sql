CREATE
OR REPLACE TABLE lk_visit_no_hadm_all AS
-- labevents
...
CREATE
OR REPLACE TABLE lk_visit_no_hadm_dist AS
SELECT src.subject_id           AS subject_id,
...
CREATE
OR REPLACE TABLE lk_visit_detail_waveform_dist AS
SELECT src.subject_id                        AS subject_id,
...
CREATE
OR REPLACE TABLE lk_visit_clean AS
SELECT hash(uuid())           AS visit_occurrence_id,
       src.subject_id         AS subject_id,
       src.hadm_id            AS hadm_id,
...
CREATE
OR REPLACE TABLE lk_visit_detail_clean AS
SELECT hash(uuid())         AS visit_detail_id,
       src.subject_id       AS subject_id,
       src.hadm_id          AS hadm_id,
       src.date_id          AS date_id,
       src.start_datetime   AS start_datetime,
...
CREATE
OR REPLACE TABLE lk_visit_detail_prev_next AS
...
CREATE
OR REPLACE TABLE lk_visit_concept AS
