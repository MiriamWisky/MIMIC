CREATE OR REPLACE TABLE tmp_custom_concept AS (
SELECT
...
CREATE OR REPLACE TABLE tmp_custom_concept_relationship AS (
SELECT
...
CREATE OR REPLACE TABLE tmp_custom_vocabulary_dist AS (
SELECT
...
CREATE OR REPLACE TABLE tmp_custom_vocabulary AS (
SELECT
    voc.source_vocabulary_id        AS vocabulary_id,
...
CREATE OR REPLACE TABLE tmp_voc_concept AS (
SELECT *
FROM
    concept
WHERE
...
CREATE OR REPLACE TABLE tmp_voc_concept_relationship AS (
SELECT vr.*
FROM
...
CREATE OR REPLACE TABLE tmp_voc_vocabulary AS (
SELECT *
FROM
    vocabulary
WHERE
...
CREATE OR REPLACE TABLE tmp_custom_concept_skipped AS (
SELECT
    tcc.*
FROM
